...
//	prof registers for course if no one is allocated to it
	public Boolean registerCourse(Integer instructorID, Integer semesterID,String courseID)throws SQLException,ProfessorCourseRegistrationException, Exception;
