...
//			System.out.println(r.getCourseID()+" "+r.getCoursename());
	...
	String queryStr;
			...
			String queryStrCheck = "SELECT * FROM registered_courses WHERE student_id = ? AND course_id = ? AND semester_id = ?";
			stmt2 = connection.prepareStatement(queryStrCheck);
	    	ResultSet rs = stmt2.executeQuery();
	    	System.out.println(rs.getBoolean("is_approved"));
	    	if(!rs.getBoolean("is_approved")) {
	    		System.out.println("Course is not approved by Admin!!");
	    	}
	    	else {
